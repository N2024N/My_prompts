"""
Test the new Supabase service using requests library.
"""
...
try:
    ...
    print(f"✅ Service created: URL={service.url[:40]}...")
    ...
    if validation["valid"]:
        print(f"❌ Unexpected: Code {test_code} should not be valid")
    else:
        print(f"✅ Correctly rejected non-existent code: {validation['message']}")
